...
class Board():
    ...
    def place_stone(self, player, point):
        ...
        for same_colot_string in adjacent_same_color:
            new_string = new_string.merged_with(same_colot_string)
        ...
        # If any oppositecolor strings now have zero liberties, remove them.
        for other_color_string in adjacent_opposite_color:
